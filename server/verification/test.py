...
class FaceVerificationModel:
    ...
    def verify(self, img1_path, img2_path):
        try:
            result = self.model.verify(img1_path, img2_path, enforce_detection=False)
...
def main():
    ...
    img1_path = "C:/Users/LENOVO/Pictures/Camera Roll/WIN_20251121_23_59_05_Pro.jpg"
    img2_path = "C:/Users/LENOVO/Downloads/Screenshot 2025-11-11 141523.png"
    # Initialize model
